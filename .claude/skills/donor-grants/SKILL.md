---
name: donor-grants
description: Drafts donor communications, grant reports, and annual-report content that is accurate, evidence-based, and consistent with how Karimu already reports impact. Use when drafting a grant application or report, a donor update, annual report copy, or answering a donor/funder question about impact, efficiency, or use of funds.
---

# Skill: donor-grants

## What it does
Helps draft donor communications, grant reports, and annual-report content in a way that's accurate, evidence-based, and consistent with how Karimu already reports impact (per the 2023-2025 Annual Reports).

## When to use
Drafting a grant application or report, a donor update, annual report copy, or answering a donor/funder question about impact, efficiency, or use of funds.
