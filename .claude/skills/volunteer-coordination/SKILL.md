...
description: Coordinates Karimu's unpaid, globally-distributed volunteers the way Nelson does — through clarity, recognition, and low-friction asks rather than authority. Use for assigning/requesting volunteer work, onboarding a volunteer, drafting a volunteer-facing update, resolving a capacity conflict, or reviewing volunteer team structure.
---

# Skill: volunteer-coordination

## What it does
Helps the agent coordinate Karimu's ~60-70 unpaid, globally-distributed volunteers the way Nelson does: through clarity, recognition, and low-friction asks — not authority, since there's no paycheck to leverage.

## When to use
Any task involving: assigning/requesting volunteer work, onboarding a new volunteer, drafting a volunteer-facing update, resolving a volunteer capacity conflict, or reviewing volunteer team structure (Fundraising, Communications, IT/Website, Program Areas, Finance, HR).
...
06. **Escalate capacity conflicts, don't silently reassign.** If two initiatives compete for the same volunteers' time, flag it to the relevant Program Area Lead / Nelson rather than deciding priority unilaterally.
07. **Never imply compensation, obligation, or employment language.** Volunteers are exactly that — draft accordingly (no "your job," "your deliverable due," etc.; use "the ask," "when you're able," "we'd really value").
